...
|---|---:|---:|---:|---:|---:|
| CPU operator types | 112 | 117 | 104 | 8 | 13 |
| Kernel types | 96 | 114 | 58 | 38 | 56 |
| Known operator types | 46 | 49 | 36 | 10 | 13 |
| Known shape/dtype variants | 1384 | 1457 | 778 | 606 | 679 |
...
| Batch wall time (s) | 16.763174 | 7.732620 | 0.461286 |
| Kernel events | 431551.000000 | 347278.000000 | 0.804721 |
| Kernel duration (us) | 9715739.225000 | 6522629.903000 | 0.671347 |
...
| nvjet_tst_256x128_64x4_1x2_h_bz_coopA_TNT | 0.580341 | 2.710106 | +2.129765 |
| void at::native::elementwise_kernel<128, 4, at::native::gpu_kernel_impl_nocast<at::native::BinaryFunctor<c10::BFloat16, c10::BFloat16, c10::BFloat16, at::native::binary_internal::MulFunctor<float> > >(at::TensorIteratorBase&, at::native::BinaryFunctor<c10::BFloat16, c10::BFloat16, c10::BFloat16, at::native::binary_internal::MulFunctor<float> > const&)::{lambda(int)#1}>(int, at::native::gpu_kernel_impl_nocast<at::native::BinaryFunctor<c10::BFloat16, c10::BFloat16, c10::BFloat16, at::native::binary_internal::MulFunctor<float> > >(at::TensorIteratorBase&, at::native::BinaryFunctor<c10::BFloat16, c10::BFloat16, c10::BFloat16, at::native::binary_internal::MulFunctor<float> > const&)::{lambda(int)#1}) | 0.000000 | 2.431551 | +2.431551 |
| nvjet_tst_64x8_64x16_2x4_h_bz_TNT | 1.235491 | 1.839128 | +0.603637 |
| nvjet_tst_64x32_64x16_4x2_h_bz_TNT | 0.368474 | 1.541317 | +1.172843 |
| triton_red_fused__to_copy_add_copy__fused_add_rms_norm_moe_forward_shared_3 | 1.035644 | 1.536876 | +0.501232 |

## Largest attributed operator shares

| operator_name | Left % | Right % | Delta pp |
|---|---:|---:|---:|
| aten::mm | 43.046178 | 9.642638 | -33.403541 |
| vllm::moe_forward_shared | 8.723336 | 12.785310 | +4.061974 |
| vllm::flashinfer_trtllm_fused_allreduce_norm | 3.171772 | 9.224341 | +6.052570 |
| symm_mem::two_shot_all_reduce_ | 1.555652 | 6.897359 | +5.341707 |
| vllm::unified_attention_with_output | 6.014236 | 0.000000 | -6.014236 |
| vllm::qwen_gdn_attention_core | 3.417217 | 5.054888 | +1.637671 |
| aten::sum | 0.000000 | 2.302456 | +2.302456 |
| triton_red_fused__to_copy_add_copy__fused_add_rms_norm_moe_forward_shared_3 | 0.827102 | 1.234686 | +0.407583 |
| _vllm_fa3_C::fwd | 0.000000 | 1.134983 | +1.134983 |
| aten::mul | 0.288345 | 0.893560 | +0.605215 |
| _C::silu_and_mul | 0.000000 | 0.827095 | +0.827095 |
| _moe_C::moe_align_block_size | 0.000000 | 0.686611 | +0.686611 |
| aten::copy_ | 0.413490 | 0.612113 | +0.198623 |
| triton_per_fused_1 | 0.362578 | 0.540590 | +0.178012 |
| triton_poi_fused_add_4 | 0.333640 | 0.500064 | +0.166424 |
